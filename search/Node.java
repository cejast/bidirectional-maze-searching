...
public class Node {
    ...
    State st;   // state corresponding to this node
    Node previousNode; // parent of this node in the search tree
    Action lastAction; // action that was taken to get from the previousNode to this node
    int depth;
    int cost;
